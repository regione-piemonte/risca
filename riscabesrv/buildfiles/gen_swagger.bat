...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\swagger_test.yaml -l java -o .. --config swagger_config_java_riscabe.json
rem echo
