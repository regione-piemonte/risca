...
public class ComuneExtendedDTO   {
  ...
  @Min(value = 1, message = "L' id_comune deve essere maggiore di 0")
  @Max(value = Integer.MAX_VALUE, message = "L' id_comune supera il limite massimo consentito per Integer")
