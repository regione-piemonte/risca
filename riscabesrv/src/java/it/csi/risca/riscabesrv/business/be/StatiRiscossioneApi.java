...
public interface StatiRiscossioneApi {
    ...
    Response loadStatiRiscossione(@Context SecurityContext securityContext, @Context HttpHeaders httpHeaders, @Context HttpServletRequest httpRequest);
