 ...
 * @author CSI PIEMONTE
 */
public class StatoDebitorioTributiDAOImpl extends RiscaBeSrvGenericDAO<StatoDebitorioDTO> {
	...
	public static final String QUERY_INSERT = "INSERT INTO risca_t_stato_debitorio "
			+ "(id_stato_debitorio, id_riscossione, id_provvedimento, id_soggetto, id_gruppo_soggetto, id_recapito, "
			...
			+ "VALUES(:idStatoDebitorio, :idRiscossione, :idProvvedimento, :idSoggetto, :idGruppoSoggetto, :idRecapito, "
	...
	public static final String QUERY_INSERT_UPD_DA_COMPENSARE = "insert into RISCA_W_STATO_DEBITORIO_UPD "
			+ "select id_stato_debitorio, id_riscossione, id_provvedimento, id_soggetto, id_gruppo_soggetto, id_recapito,  "
			+ "id_attivita_stato_deb, id_stato_contribuzione, id_tipo_dilazione, nap, num_titolo, data_provvedimento,  "
			+ "num_richiesta_protocollo, data_richiesta_protocollo, data_ultima_modifica, des_usi, note,  "
			+ "imp_recupero_canone, imp_recupero_interessi, imp_spese_notifica, imp_compensazione_canone,  "
			+ "desc_periodo_pagamento, desc_motivo_annullo, flg_annullato, flg_restituito_mittente, flg_invio_speciale,  "
	...
	public static final String QUERY_UPDATE = "update risca_t_stato_debitorio "
			+ " set id_riscossione = :idRiscossione, id_provvedimento = :idProvvedimento, id_soggetto =:idSoggetto, "
...
//					if(statoDebitorioDTO.getIdProvvedimento() != null) {
//						map.put("idProvvedimento", statoDebitorioDTO.getIdProvvedimento());
//						MapSqlParameterSource param = getParameterValue(map);
//						String descTipoTitolo = template.query(QUERY_SELECT_DESC_TIPO_TITOLO, param, new ResultSetExtractor<String>(){
//						    @Override
//						    public String extractData(ResultSet rs) throws SQLException,DataAccessException {
//						    	String descTipoTitolo = null;
//						        while(rs.next()){
//						        	descTipoTitolo = rs.getString("des_tipo_titolo");
//						        }
//						        return descTipoTitolo;
//						    }
//						});
//						statoDebitorioDTO.setTipoTitolo(descTipoTitolo);
//					}
					}
...
//						BigDecimal importoVersato = canoneDovuto;
...
//							impCompensazioneCanone= statoDebitorioDTO.getImpCompensazioneCanone() ;
//						}
//						importoVersato = importoVersato.subtract(impCompensazioneCanone);
//						statoDebitorioDTO.setImportoVersato(importoVersato);
