...
public class AcarisFaultType  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    private it.csi.risca.riscabesrv.util.actarepository.ObjectIdType objectId;
    ...
    public AcarisFaultType(
           ...
           it.csi.risca.riscabesrv.util.actarepository.ObjectIdType objectId,
     ...
     * @return objectId
     */
    public it.csi.risca.riscabesrv.util.actarepository.ObjectIdType getObjectId() {
        return objectId;
    }
     ...
     * @param objectId
     */
    public void setObjectId(it.csi.risca.riscabesrv.util.actarepository.ObjectIdType objectId) {
        this.objectId = objectId;
    }
