...
public class PropertyFilterType  implements java.io.Serializable {
    ...
    private it.csi.risca.riscabesrv.util.actanavigation.QueryNameType[] propertyList;
    ...
    public PropertyFilterType(
           ...
           it.csi.risca.riscabesrv.util.actanavigation.QueryNameType[] propertyList) {
     ...
     * @return propertyList
     */
    public it.csi.risca.riscabesrv.util.actanavigation.QueryNameType[] getPropertyList() {
        return propertyList;
    }
     ...
     * @param propertyList
     */
    public void setPropertyList(it.csi.risca.riscabesrv.util.actanavigation.QueryNameType[] propertyList) {
        this.propertyList = propertyList;
    }

    public it.csi.risca.riscabesrv.util.actanavigation.QueryNameType getPropertyList(int i) {
        return this.propertyList[i];
    }

    public void setPropertyList(int i, it.csi.risca.riscabesrv.util.actanavigation.QueryNameType _value) {
