 ...
 *******************************************************************************/
/**
 * VolumeFascicoliPropertiesType.java
 *
...
public class VolumeFascicoliPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.VolumePropertiesType  implements java.io.Serializable {
    public VolumeFascicoliPropertiesType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof VolumeFascicoliPropertiesType)) return false;
        VolumeFascicoliPropertiesType other = (VolumeFascicoliPropertiesType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VolumeFascicoliPropertiesType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "VolumeFascicoliPropertiesType"));
    }
