...
public abstract class FolderPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.ArchivePropertiesType  implements java.io.Serializable {
    private java.lang.String objectTypeId;

    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType parentId;
     ...
     * @return parentId
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getParentId() {
        return parentId;
    }
     ...
     * @param parentId
     */
    public void setParentId(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType parentId) {
        this.parentId = parentId;
    }
