 ...
 *******************************************************************************/
/**
 * FascicoloRealeAnnualePropertiesType.java
 *
...
public class FascicoloRealeAnnualePropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.FascicoloRealePropertiesType  implements java.io.Serializable {
    public FascicoloRealeAnnualePropertiesType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof FascicoloRealeAnnualePropertiesType)) return false;
        FascicoloRealeAnnualePropertiesType other = (FascicoloRealeAnnualePropertiesType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FascicoloRealeAnnualePropertiesType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "FascicoloRealeAnnualePropertiesType"));
    }
