...
public abstract class AggregazionePropertiesType  extends it.csi.risca.riscabesrv.util.actaobject.FolderPropertiesType  implements java.io.Serializable {
    ...
    private it.csi.risca.riscabesrv.util.actaobject.CodiceFiscaleType utenteCreazione;

    private it.csi.risca.riscabesrv.util.actaobject.ObjectIdType idDeposito;

    private it.csi.risca.riscabesrv.util.actaobject.IdMovimentazioneType[] idMovimentazioneList;

    private it.csi.risca.riscabesrv.util.actaobject.IdAnnotazioniType[] idAnnotazioniList;

    private int idTipoClasse;

    private it.csi.risca.riscabesrv.util.actaobject.IdAOOType idAOORespMat;

    private it.csi.risca.riscabesrv.util.actaobject.IdAOOType idAOORespCons;

    private it.csi.risca.riscabesrv.util.actaobject.IdStrutturaType idStrutturaRespMat;

    private it.csi.risca.riscabesrv.util.actaobject.IdStrutturaType idStrutturaRespCons;

    private it.csi.risca.riscabesrv.util.actaobject.IdNodoType idNodoRespMat;

    private it.csi.risca.riscabesrv.util.actaobject.IdNodoType idNodoRespCons;
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.CodiceFiscaleType getUtenteCreazione() {
        return utenteCreazione;
    }
     ...
     */
    public void setUtenteCreazione(it.csi.risca.riscabesrv.util.actaobject.CodiceFiscaleType utenteCreazione) {
        this.utenteCreazione = utenteCreazione;
    }
     ...
     * @return idDeposito
     */
    public it.csi.risca.riscabesrv.util.actaobject.ObjectIdType getIdDeposito() {
        return idDeposito;
    }
     ...
     * @param idDeposito
     */
    public void setIdDeposito(it.csi.risca.riscabesrv.util.actaobject.ObjectIdType idDeposito) {
        this.idDeposito = idDeposito;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdMovimentazioneType[] getIdMovimentazioneList() {
        return idMovimentazioneList;
    }
     ...
     */
    public void setIdMovimentazioneList(it.csi.risca.riscabesrv.util.actaobject.IdMovimentazioneType[] idMovimentazioneList) {
        this.idMovimentazioneList = idMovimentazioneList;
    }

    public it.csi.risca.riscabesrv.util.actaobject.IdMovimentazioneType getIdMovimentazioneList(int i) {
        return this.idMovimentazioneList[i];
    }

    public void setIdMovimentazioneList(int i, it.csi.risca.riscabesrv.util.actaobject.IdMovimentazioneType _value) {
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdAnnotazioniType[] getIdAnnotazioniList() {
        return idAnnotazioniList;
    }
     ...
     */
    public void setIdAnnotazioniList(it.csi.risca.riscabesrv.util.actaobject.IdAnnotazioniType[] idAnnotazioniList) {
        this.idAnnotazioniList = idAnnotazioniList;
    }

    public it.csi.risca.riscabesrv.util.actaobject.IdAnnotazioniType getIdAnnotazioniList(int i) {
        return this.idAnnotazioniList[i];
    }

    public void setIdAnnotazioniList(int i, it.csi.risca.riscabesrv.util.actaobject.IdAnnotazioniType _value) {
     ...
     * @return idAOORespMat
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdAOOType getIdAOORespMat() {
        return idAOORespMat;
    }
     ...
     * @param idAOORespMat
     */
    public void setIdAOORespMat(it.csi.risca.riscabesrv.util.actaobject.IdAOOType idAOORespMat) {
        this.idAOORespMat = idAOORespMat;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdAOOType getIdAOORespCons() {
        return idAOORespCons;
    }
     ...
     * @param idAOORespCons
     */
    public void setIdAOORespCons(it.csi.risca.riscabesrv.util.actaobject.IdAOOType idAOORespCons) {
        this.idAOORespCons = idAOORespCons;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdStrutturaType getIdStrutturaRespMat() {
        return idStrutturaRespMat;
    }
     ...
     */
    public void setIdStrutturaRespMat(it.csi.risca.riscabesrv.util.actaobject.IdStrutturaType idStrutturaRespMat) {
        this.idStrutturaRespMat = idStrutturaRespMat;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdStrutturaType getIdStrutturaRespCons() {
        return idStrutturaRespCons;
    }
     ...
     */
    public void setIdStrutturaRespCons(it.csi.risca.riscabesrv.util.actaobject.IdStrutturaType idStrutturaRespCons) {
        this.idStrutturaRespCons = idStrutturaRespCons;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdNodoType getIdNodoRespMat() {
        return idNodoRespMat;
    }
     ...
     * @param idNodoRespMat
     */
    public void setIdNodoRespMat(it.csi.risca.riscabesrv.util.actaobject.IdNodoType idNodoRespMat) {
        this.idNodoRespMat = idNodoRespMat;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdNodoType getIdNodoRespCons() {
        return idNodoRespCons;
    }
     ...
     */
    public void setIdNodoRespCons(it.csi.risca.riscabesrv.util.actaobject.IdNodoType idNodoRespCons) {
        this.idNodoRespCons = idNodoRespCons;
    }
