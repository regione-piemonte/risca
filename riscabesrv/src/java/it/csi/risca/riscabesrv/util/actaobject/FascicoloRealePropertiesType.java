...
public abstract class FascicoloRealePropertiesType  extends it.csi.risca.riscabesrv.util.actaobject.AggregazionePropertiesType  implements java.io.Serializable {
    private int anno;
    ...
    private it.csi.risca.riscabesrv.util.actaobject.IdFascicoloStandardType idFascicoloStdRiferimento;
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.IdFascicoloStandardType getIdFascicoloStdRiferimento() {
        return idFascicoloStdRiferimento;
    }
     ...
     */
    public void setIdFascicoloStdRiferimento(it.csi.risca.riscabesrv.util.actaobject.IdFascicoloStandardType idFascicoloStdRiferimento) {
        this.idFascicoloStdRiferimento = idFascicoloStdRiferimento;
    }
