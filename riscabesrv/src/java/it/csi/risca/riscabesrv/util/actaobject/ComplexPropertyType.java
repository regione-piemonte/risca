...
public class ComplexPropertyType  extends it.csi.risca.riscabesrv.util.actaobject.PropertyType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actaobject.ComplexPropertyType nested;

    public ComplexPropertyType() {
    }

    public ComplexPropertyType(
           it.csi.risca.riscabesrv.util.actaobject.QueryNameType queryName,
           java.lang.String[] value,
           it.csi.risca.riscabesrv.util.actaobject.ComplexPropertyType nested) {
        super(
            queryName,
            value);
        this.nested = nested;
     ...
     * @return nested
     */
    public it.csi.risca.riscabesrv.util.actaobject.ComplexPropertyType getNested() {
        return nested;
    }
     ...
     * @param nested
     */
    public void setNested(it.csi.risca.riscabesrv.util.actaobject.ComplexPropertyType nested) {
        this.nested = nested;
    }
