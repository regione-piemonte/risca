...
public class MittenteInterno  implements java.io.Serializable {
    ...
    /**
     * Gets the corrispondente value for this MittenteInterno.
     * 
    ...
    /**
     * Sets the corrispondente value for this MittenteInterno.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof MittenteInterno)) return false;
        MittenteInterno other = (MittenteInterno) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MittenteInterno.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("officialbookservice.acaris.acta.doqui.it", "MittenteInterno"));
