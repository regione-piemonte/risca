...
public class PropertyType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actaobject.QueryNameType queryName;
     ...
     * @return queryName
     */
    public it.csi.risca.riscabesrv.util.actaobject.QueryNameType getQueryName() {
        return queryName;
    }
     ...
     * @param queryName
     */
    public void setQueryName(it.csi.risca.riscabesrv.util.actaobject.QueryNameType queryName) {
        this.queryName = queryName;
    }
