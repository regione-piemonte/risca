...
public class NavigationConditionInfoType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actaobject.ObjectIdType parentNodeId;
    ...
    public NavigationConditionInfoType(
           it.csi.risca.riscabesrv.util.actaobject.ObjectIdType parentNodeId,
     ...
     * @return parentNodeId
     */
    public it.csi.risca.riscabesrv.util.actaobject.ObjectIdType getParentNodeId() {
        return parentNodeId;
    }
     ...
     * @param parentNodeId
     */
    public void setParentNodeId(it.csi.risca.riscabesrv.util.actaobject.ObjectIdType parentNodeId) {
        this.parentNodeId = parentNodeId;
    }
