...
public class PropertyType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actaofficialbook.QueryNameType queryName;
     ...
     * @return queryName
     */
    public it.csi.risca.riscabesrv.util.actaofficialbook.QueryNameType getQueryName() {
        return queryName;
    }
     ...
     * @param queryName
     */
    public void setQueryName(it.csi.risca.riscabesrv.util.actaofficialbook.QueryNameType queryName) {
        this.queryName = queryName;
    }
