...
public class MoveDocumentPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.PropertiesType  implements java.io.Serializable {
    private boolean offlineMoveRequest;

    private it.csi.risca.riscabesrv.util.actarelationships.IdSmistamentoType idSmistamentoType;
    ...
    public MoveDocumentPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actarelationships.IdSmistamentoType idSmistamentoType) {
     ...
     */
    public it.csi.risca.riscabesrv.util.actarelationships.IdSmistamentoType getIdSmistamentoType() {
        return idSmistamentoType;
    }
     ...
     */
    public void setIdSmistamentoType(it.csi.risca.riscabesrv.util.actarelationships.IdSmistamentoType idSmistamentoType) {
        this.idSmistamentoType = idSmistamentoType;
    }
