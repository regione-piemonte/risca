...
public class AnnotazioniPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.CommonPropertiesType  implements java.io.Serializable {
    private java.lang.String objectTypeId;

    private java.lang.String descrizione;

    private it.csi.risca.riscabesrv.util.actarelationships.IdUtenteType idUtente;
    ...
    public AnnotazioniPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actarelationships.IdUtenteType idUtente,
           java.util.Date data,
     ...
     * @return idUtente
     */
    public it.csi.risca.riscabesrv.util.actarelationships.IdUtenteType getIdUtente() {
        return idUtente;
    }
     ...
     * @param idUtente
     */
    public void setIdUtente(it.csi.risca.riscabesrv.util.actarelationships.IdUtenteType idUtente) {
        this.idUtente = idUtente;
    }
