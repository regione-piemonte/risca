...
public class PropertyType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actanavigation.QueryNameType queryName;
     ...
     * @return queryName
     */
    public it.csi.risca.riscabesrv.util.actanavigation.QueryNameType getQueryName() {
        return queryName;
    }
     ...
     * @param queryName
     */
    public void setQueryName(it.csi.risca.riscabesrv.util.actanavigation.QueryNameType queryName) {
        this.queryName = queryName;
    }
