...
public abstract class CommonPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.PropertiesType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType objectId;

    private it.csi.risca.riscabesrv.util.actarelationships.ChangeTokenType changeToken;
     ...
     * @return objectId
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getObjectId() {
        return objectId;
    }
     ...
     * @param objectId
     */
    public void setObjectId(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType objectId) {
        this.objectId = objectId;
    }
     ...
     * @return changeToken
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ChangeTokenType getChangeToken() {
        return changeToken;
    }
     ...
     * @param changeToken
     */
    public void setChangeToken(it.csi.risca.riscabesrv.util.actarelationships.ChangeTokenType changeToken) {
        this.changeToken = changeToken;
    }
