...
public abstract class SeriePropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.AggregazionePropertiesType  implements java.io.Serializable {
    public SeriePropertiesType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof SeriePropertiesType)) return false;
        SeriePropertiesType other = (SeriePropertiesType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SeriePropertiesType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "SeriePropertiesType"));
    }
