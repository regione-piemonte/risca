 ...
 *******************************************************************************/
/**
 * VolumeSottofascicoliPropertiesType.java
 *
...
public class VolumeSottofascicoliPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.VolumePropertiesType  implements java.io.Serializable {
    public VolumeSottofascicoliPropertiesType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof VolumeSottofascicoliPropertiesType)) return false;
        VolumeSottofascicoliPropertiesType other = (VolumeSottofascicoliPropertiesType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VolumeSottofascicoliPropertiesType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "VolumeSottofascicoliPropertiesType"));
    }
