...
public abstract class GenericACEPropertiesType  extends it.csi.risca.riscabesrv.util.actaobject.PolicyPropertiesType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actaobject.PrincipalIdType[] principalList;
    ...
    public GenericACEPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actaobject.PrincipalIdType[] principalList) {
        super(
            objectId,
            changeToken,
            objectTypeId,
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.PrincipalIdType[] getPrincipalList() {
        return principalList;
    }
     ...
     * @param principalList
     */
    public void setPrincipalList(it.csi.risca.riscabesrv.util.actaobject.PrincipalIdType[] principalList) {
        this.principalList = principalList;
    }

    public it.csi.risca.riscabesrv.util.actaobject.PrincipalIdType getPrincipalList(int i) {
        return this.principalList[i];
    }

    public void setPrincipalList(int i, it.csi.risca.riscabesrv.util.actaobject.PrincipalIdType _value) {
