...
public class RelationshipPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.ArchivePropertiesType  implements java.io.Serializable {
    private java.lang.String relationType;

    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType sourceId;

    private java.lang.String sourceType;

    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType targetId;
    ...
    public RelationshipPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType sourceId,
           java.lang.String sourceType,
           it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType targetId,
     ...
     * @return sourceId
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getSourceId() {
        return sourceId;
    }
     ...
     * @param sourceId
     */
    public void setSourceId(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType sourceId) {
        this.sourceId = sourceId;
    }
     ...
     * @return targetId
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getTargetId() {
        return targetId;
    }
     ...
     * @param targetId
     */
    public void setTargetId(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType targetId) {
        this.targetId = targetId;
    }
