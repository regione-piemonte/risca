...
public class GruppoAllegatiPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.FolderPropertiesType  implements java.io.Serializable {
    ...
    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType classificazionePrincipale;
    ...
    public GruppoAllegatiPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType classificazionePrincipale) {
        super(
            objectId,
            changeToken,
            objectTypeId,
     ...
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getClassificazionePrincipale() {
        return classificazionePrincipale;
    }
     ...
     */
    public void setClassificazionePrincipale(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType classificazionePrincipale) {
        this.classificazionePrincipale = classificazionePrincipale;
    }
