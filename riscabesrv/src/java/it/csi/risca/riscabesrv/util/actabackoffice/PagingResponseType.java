...
public class PagingResponseType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actabackoffice.ObjectResponseType[] objects;
    ...
    public PagingResponseType(
           it.csi.risca.riscabesrv.util.actabackoffice.ObjectResponseType[] objects,
     ...
     * @return objects
     */
    public it.csi.risca.riscabesrv.util.actabackoffice.ObjectResponseType[] getObjects() {
        return objects;
    }
     ...
     * @param objects
     */
    public void setObjects(it.csi.risca.riscabesrv.util.actabackoffice.ObjectResponseType[] objects) {
        this.objects = objects;
    }

    public it.csi.risca.riscabesrv.util.actabackoffice.ObjectResponseType getObjects(int i) {
        return this.objects[i];
    }

    public void setObjects(int i, it.csi.risca.riscabesrv.util.actabackoffice.ObjectResponseType _value) {
