...
public class ComplexPropertyType  extends it.csi.risca.riscabesrv.util.actanavigation.PropertyType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actanavigation.ComplexPropertyType nested;

    public ComplexPropertyType() {
    }

    public ComplexPropertyType(
           it.csi.risca.riscabesrv.util.actanavigation.QueryNameType queryName,
           java.lang.String[] value,
           it.csi.risca.riscabesrv.util.actanavigation.ComplexPropertyType nested) {
        super(
            queryName,
            value);
        this.nested = nested;
     ...
     * @return nested
     */
    public it.csi.risca.riscabesrv.util.actanavigation.ComplexPropertyType getNested() {
        return nested;
    }
     ...
     * @param nested
     */
    public void setNested(it.csi.risca.riscabesrv.util.actanavigation.ComplexPropertyType nested) {
        this.nested = nested;
    }
