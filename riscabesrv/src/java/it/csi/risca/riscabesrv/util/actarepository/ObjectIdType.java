...
public class ObjectIdType  implements java.io.Serializable {
    ...
    /**
     * Gets the value value for this ObjectIdType.
     * 
     * @return value
     */
    ...
    /**
     * Sets the value value for this ObjectIdType.
     * 
     * @param value
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("common.acaris.acta.doqui.it", "ObjectIdType"));
