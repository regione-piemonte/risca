 ...
 *******************************************************************************/
/**
 * VolumeSerieTipologicaDocumentiPropertiesType.java
 *
...
public class VolumeSerieTipologicaDocumentiPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.VolumePropertiesType  implements java.io.Serializable {
    public VolumeSerieTipologicaDocumentiPropertiesType() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof VolumeSerieTipologicaDocumentiPropertiesType)) return false;
        VolumeSerieTipologicaDocumentiPropertiesType other = (VolumeSerieTipologicaDocumentiPropertiesType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(VolumeSerieTipologicaDocumentiPropertiesType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("archive.acaris.acta.doqui.it", "VolumeSerieTipologicaDocumentiPropertiesType"));
    }
