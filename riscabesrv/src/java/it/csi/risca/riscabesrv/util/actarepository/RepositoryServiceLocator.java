...
public class RepositoryServiceLocator extends org.apache.axis.client.Service implements it.csi.risca.riscabesrv.util.actarepository.RepositoryService {
    ...
    public it.csi.risca.riscabesrv.util.actarepository.RepositoryServicePort_PortType getRepositoryServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public it.csi.risca.riscabesrv.util.actarepository.RepositoryServicePort_PortType getRepositoryServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.csi.risca.riscabesrv.util.actarepository.RepositoryServiceBindingStub _stub = new it.csi.risca.riscabesrv.util.actarepository.RepositoryServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.csi.risca.riscabesrv.util.actarepository.RepositoryServicePort_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.csi.risca.riscabesrv.util.actarepository.RepositoryServiceBindingStub _stub = new it.csi.risca.riscabesrv.util.actarepository.RepositoryServiceBindingStub(new java.net.URL(RepositoryServicePort_address), this);
                _stub.setPortName(getRepositoryServicePortWSDDServiceName());
                return _stub;
            }
        }
