...
public class ContenutoFisicoPropertiesType  extends it.csi.risca.riscabesrv.util.actaobject.DocumentPropertiesType  implements java.io.Serializable {
    ...
    private it.csi.risca.riscabesrv.util.actaobject.DatiCertificatoType[] datiCertificato;
    ...
    public ContenutoFisicoPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actaobject.DatiCertificatoType[] datiCertificato,
           boolean sbustamento,
     ...
     */
    public it.csi.risca.riscabesrv.util.actaobject.DatiCertificatoType[] getDatiCertificato() {
        return datiCertificato;
    }
     ...
     */
    public void setDatiCertificato(it.csi.risca.riscabesrv.util.actaobject.DatiCertificatoType[] datiCertificato) {
        this.datiCertificato = datiCertificato;
    }

    public it.csi.risca.riscabesrv.util.actaobject.DatiCertificatoType getDatiCertificato(int i) {
        return this.datiCertificato[i];
    }

    public void setDatiCertificato(int i, it.csi.risca.riscabesrv.util.actaobject.DatiCertificatoType _value) {
