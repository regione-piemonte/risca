...
public class IdentitaNonAutenticaException  extends UserException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:PolicyEnforcerBase", "IdentitaNonAutenticaException"));
    }
