...
public abstract class DocumentoPropertiesType  extends it.csi.risca.riscabesrv.util.actarelationships.DocumentPropertiesType  implements java.io.Serializable {
    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType idCorrente;
    ...
    private it.csi.risca.riscabesrv.util.actarelationships.IdStatoDiEfficaciaType idStatoDiEfficacia;

    private it.csi.risca.riscabesrv.util.actarelationships.IdFormaDocumentariaType idFormaDocumentaria;

    private boolean firmaElettronica;

    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] idProtocollo;
    ...
    private it.csi.risca.riscabesrv.util.actarelationships.IdVitalRecordCodeType idVitalRecordCode;

    private it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] idAnnotazioniList;
    ...
    public DocumentoPropertiesType(
           ...
           it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType idCorrente,
           boolean registrato,
           ...
           it.csi.risca.riscabesrv.util.actarelationships.IdStatoDiEfficaciaType idStatoDiEfficacia,
           it.csi.risca.riscabesrv.util.actarelationships.IdFormaDocumentariaType idFormaDocumentaria,
           boolean firmaElettronica,
           it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] idProtocollo,
           ...
           it.csi.risca.riscabesrv.util.actarelationships.IdVitalRecordCodeType idVitalRecordCode,
           it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] idAnnotazioniList,
     ...
     * @return idCorrente
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getIdCorrente() {
        return idCorrente;
    }
     ...
     * @param idCorrente
     */
    public void setIdCorrente(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType idCorrente) {
        this.idCorrente = idCorrente;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actarelationships.IdStatoDiEfficaciaType getIdStatoDiEfficacia() {
        return idStatoDiEfficacia;
    }
     ...
     */
    public void setIdStatoDiEfficacia(it.csi.risca.riscabesrv.util.actarelationships.IdStatoDiEfficaciaType idStatoDiEfficacia) {
        this.idStatoDiEfficacia = idStatoDiEfficacia;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actarelationships.IdFormaDocumentariaType getIdFormaDocumentaria() {
        return idFormaDocumentaria;
    }
     ...
     */
    public void setIdFormaDocumentaria(it.csi.risca.riscabesrv.util.actarelationships.IdFormaDocumentariaType idFormaDocumentaria) {
        this.idFormaDocumentaria = idFormaDocumentaria;
    }
     ...
     * @return idProtocollo
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] getIdProtocollo() {
        return idProtocollo;
    }
     ...
     * @param idProtocollo
     */
    public void setIdProtocollo(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] idProtocollo) {
        this.idProtocollo = idProtocollo;
    }

    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getIdProtocollo(int i) {
        return this.idProtocollo[i];
    }

    public void setIdProtocollo(int i, it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType _value) {
     ...
     */
    public it.csi.risca.riscabesrv.util.actarelationships.IdVitalRecordCodeType getIdVitalRecordCode() {
        return idVitalRecordCode;
    }
     ...
     */
    public void setIdVitalRecordCode(it.csi.risca.riscabesrv.util.actarelationships.IdVitalRecordCodeType idVitalRecordCode) {
        this.idVitalRecordCode = idVitalRecordCode;
    }
     ...
     */
    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] getIdAnnotazioniList() {
        return idAnnotazioniList;
    }
     ...
     */
    public void setIdAnnotazioniList(it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType[] idAnnotazioniList) {
        this.idAnnotazioniList = idAnnotazioniList;
    }

    public it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType getIdAnnotazioniList(int i) {
        return this.idAnnotazioniList[i];
    }

    public void setIdAnnotazioniList(int i, it.csi.risca.riscabesrv.util.actarelationships.ObjectIdType _value) {
