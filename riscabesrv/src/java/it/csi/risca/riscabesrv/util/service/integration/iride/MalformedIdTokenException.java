 ...
 *******************************************************************************/
/**
 * MalformedIdTokenException.java
 *
...
public class MalformedIdTokenException  extends UserException  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof MalformedIdTokenException)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MalformedIdTokenException.class, true);
