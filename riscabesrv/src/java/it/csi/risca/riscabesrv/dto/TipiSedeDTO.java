...
public class TipiSedeDTO {
	...
	@Min(value = 1, message = "L' id_tipo_sede deve essere maggiore di 0")
	@Max(value = Integer.MAX_VALUE, message = "L' id_tipo_sede supera il limite massimo consentito per Integer")
