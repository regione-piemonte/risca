...
public class NazioniDTO {
	  ...
	  @Min(value = 1, message = "L' id_nazione deve essere maggiore di 0")
	  @Max(value = Integer.MAX_VALUE, message = "L' id_nazione supera il limite massimo consentito per Integer")
