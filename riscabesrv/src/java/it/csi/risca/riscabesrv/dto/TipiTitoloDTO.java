...
public class TipiTitoloDTO {
    ...
    @Min(value = 1, message = "L' id_tipo_titolo deve essere maggiore di 0")
   @Max(value = Integer.MAX_VALUE, message = "L' id_tipo_titolo supera il limite massimo consentito per Integer")
	...
	public Long getOrdinaTipoTitolo() {
		return ordinaTipoTitolo;
	}

	public void setOrdinaTipoTitolo(Long ordinaTipoTitolo) {
		this.ordinaTipoTitolo = ordinaTipoTitolo;
	}
