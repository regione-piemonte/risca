 ...
 *  =========================LICENSE_END==================================
 *******************************************************************************/
package it.csi.risca.riscaboweb.business.be.helper.iride;
...
import it.csi.risca.riscaboweb.util.service.integration.iride.PolicyEnforcerBaseService;
import it.csi.risca.riscaboweb.util.service.integration.iride.PolicyEnforcerBaseServiceServiceLocator;
...
public class IrideServiceHelper extends AbstractServiceHelper {
    ...
    private PolicyEnforcerBaseService service;
    /**
     * The Url service.
     */
    ...
    private PolicyEnforcerBaseService getService(String urlService) {
        LOGGER.debug("[IrideServiceHelper::getService] BEGIN");
        PolicyEnforcerBaseService server  = null;
        try {
...
//            return ruoli;
    ...
    public boolean isIdentitaAutentica(Identita identita) {
        ...
        try {
            ...
            LOGGER.debug("[IrideServiceHelper::isIdentitaAutentica] END result: " + identitaAutentica);
