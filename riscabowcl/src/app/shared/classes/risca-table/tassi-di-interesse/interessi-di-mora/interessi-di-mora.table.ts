 ...
 */
interface IInteressiDiMoraTable {
  percentuale?: number;
  dataInizio?: string;
  dataFine?: string;
}
 ...
 */
export interface IInteressiDiMoraTableConfigs {
 ...
 */
export const interessiDiMoraTablePagination: () => RiscaTablePagination =
  () => {
    return {
      total: 0,
 ...
 */
export class InteressiDiMoraTable
  extends RiscaTableClass<IInteressiDiMoraTable>
  implements IRiscaTableClass<IInteressiDiMoraTable>
{
   ...
   * Costruttore.
   */
  constructor(interessiDiMoraConfigs?: IInteressiDiMoraTableConfigs) {
    // Richiamo il super
    super();

    // Estraggo dalla configurazione i parametri
    const { interessiDiMora, paginazione, AEADisabled } =
      interessiDiMoraConfigs ?? {};
    ...
    this.setElements(interessiDiMora);
  ...
  setTableFunctions() {
    ...
    this.converter = (il: InteressiDiMoraVo): IInteressiDiMoraTable => {
      ...
      let columnsData: IInteressiDiMoraTable = {
        percentuale,
        dataInizio,
        dataFine,
      };
          ...
          actions: [
            {
              ...
              disable: (v?: RiscaTableDataConfig<InteressiDiMoraVo>) => {
            ...
            },
            {
              ...
              visible: (v?: RiscaTableDataConfig<InteressiDiMoraVo>) => {
  ...
  getDefaultPagination(): RiscaTablePagination {
    ...
    return interessiDiMoraTablePagination();
  }
