 ...
 */
export interface IUsiLeggeSDTableConfigs {
 ...
 */
export class UsiLeggeSDTable
  extends RiscaTableClass<IUsoLeggeSDInfoTable>
  implements IRiscaTableClass<IUsoLeggeSDInfoTable>
{
  private STYLE_USO_DI_LEGGE = { 'min-width': '110px' };
  private STYLE_USO_SPECIFICO = { 'min-width': '160px' };
  private STYLE_UNITÀ_DI_MISURA = { 'min-width': '115px' };
  private STYLE_CANONE_H = { 'min-width': '115px' };
  private STYLE_CANONE_B = { 'text-align': 'right' };
  private STYLE_CANONE_UNITARIO_H = { 'min-width': '115px' };
  private STYLE_CANONE_UNITARIO_B = { 'text-align': 'right' };
  private STYLE_QUANTITA_H = { 'min-width': '125px' };
  private STYLE_QUANTITA_B = { 'text-align': 'right' };
  private STYLE_PERC_RIDUZIONE_MOTIVAZIONE = { 'min-width': '155px' };
  private STYLE_PERC_AUMENTO_MOTIVAZIONE = { 'min-width': '155px' };
  private STYLE_QUANTITA_FALDA_PROFONDA_H = { 'min-width': '155px' };
  private STYLE_QUANTITA_FALDA_PROFONDA_B = { 'text-align': 'right' };
  private STYLE_QUANTITA_FALDA_SUPERFICIALE_H = { 'min-width': '165px' };
  private STYLE_QUANTITA_FALDA_SUPERFICIALE_B = { 'text-align': 'right' };
  private STYLE_DATA_SCADENZA_EMAS_ISO = { 'min-width': '150px' };
  private STYLE_AZIONI = { 'min-width': '80px' };
  ...
  /** Boolean che definisce se i pulsanti delle azioni devono essere disattivati. */
  public disableActions: boolean = false;

  /**
   * Costruttore.
   */
  constructor(configs: IUsiLeggeSDTableConfigs) {
    // Richiamo il super
    super();
  ...
  setTableFunctions() {
    ...
    this.converter = (usoDiLeggeInfo: UsoLeggePSDAmbienteInfo) => {
      ...
      // RISCA-ISSUES-39: il canone uso frazionato prende la priorità di visualizzazione rispetto al canone uso, ma solo se è stato definito come dato.
      const canoneUso = usoDiLeggeInfo.canoneUso;
      // const canoneUsoFrazionato = usoDiLeggeInfo.canoneUsoFrazionato;
      let canone = /* canoneUsoFrazionato ?? */ canoneUso;
      let canoneUnitario = usoDiLeggeInfo.canoneUnitarioUso;
      ...
      // Gestisco la data scadenza emas iso
      const dataScadenzaEmasIso = convertNgbDateStructToViewDate(
        usoDiLeggeInfo.dataScadenzaEmasIso
      );

      // Effettuo il parsing  delle informazioni in input
      const config: IUsoLeggeSDInfoTable = {
        usoDiLeggeDes,
        listUsoSpecDes,
        unitaDiMisuraDes,
        canone,
    ...
    sourceMap.push(
      {
        header: new RiscaTableSourceMapHeader({
          ...
          cssCell: this.STYLE_USO_DI_LEGGE,
        }),
            ...
            actions: [
              {
                ...
                popover: new RiscaPopoverConfig({
                  ngbPopover: (e: UsoLeggePSDAmbienteInfo) => {
                    ...
                    const innertHTML = e?.extras?.popoverAnnualita();
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          label: 'Uso specifico',
          sortable: true,
          cssCell: this.STYLE_USO_SPECIFICO,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          sourceData: {
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_UNITÀ_DI_MISURA,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          label: 'Canone',
          sortable: true,
          cssCell: this.STYLE_CANONE_H,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          cssCell: this.STYLE_CANONE_B,
          sourceData: {
            property: 'canone',
            type: 'number',
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_CANONE_UNITARIO_H,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          cssCell: this.STYLE_CANONE_UNITARIO_B,
          sourceData: {
            property: 'canoneUnitario',
            type: 'number',
            outputFormat: (v: number) => {
              // Ritorno la formattazione numerica per italia
              return formatoImportoITA(v);
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          label: 'Quantità',
          sortable: true,
          cssCell: this.STYLE_QUANTITA_H,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          cssCell: this.STYLE_QUANTITA_B,
          sourceData: {
            property: 'quantita',
            type: 'number',
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_PERC_RIDUZIONE_MOTIVAZIONE,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          sourceData: {
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_PERC_AUMENTO_MOTIVAZIONE,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          sourceData: {
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_QUANTITA_FALDA_PROFONDA_H,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          cssCell: this.STYLE_QUANTITA_FALDA_PROFONDA_B,
          sourceData: {
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_QUANTITA_FALDA_SUPERFICIALE_H,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          cssCell: this.STYLE_QUANTITA_FALDA_SUPERFICIALE_B,
          sourceData: {
      ...
      },
      {
        header: new RiscaTableSourceMapHeader({
          ...
          sortable: true,
          cssCell: this.STYLE_DATA_SCADENZA_EMAS_ISO,
        }),
        body: new RiscaTableSourceMapBody({
          useSource: true,
          sourceData: {
            ...
            actions: [
              {
                ...
                disable: (v: any) => {
                  ...
                  const disabledUI = this._disableUserInputs ?? false;
                  // Recupero la configurazione per le azioni
                  const disableA = this.disableActions ?? false;

                  // Ritorno lo stato di disabled
                  return disabledUI || disableA;
                },
              },
              {
