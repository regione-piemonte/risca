...
import { RiscaFormInputEmail, RiscaFormInputText } from '../../../utilities';
import { FormInputComponent } from '../form-input/form-input.component';

@Component({
  selector: 'risca-email',
  templateUrl: './risca-email.component.html',
  styleUrls: ['./risca-email.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => RiscaEmailComponent),
      multi: true,
    },
  ],
})
export class RiscaEmailComponent
  extends FormInputComponent<RiscaFormInputEmail>
