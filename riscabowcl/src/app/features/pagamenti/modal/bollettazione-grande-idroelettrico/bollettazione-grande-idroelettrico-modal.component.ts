...
@Component({
  selector: 'bollettazione-grande-idroelettrico-modal',
  templateUrl: './bollettazione-grande-idroelettrico-modal.component.html',
  styleUrls: ['./bollettazione-grande-idroelettrico-modal.component.scss'],
})
export class BollettazioneGrandeIdroelettricoModalComponent extends BollettiniModalComponent<IBGIModalForm> {
  /**
   * Costruttore.
   */
  constructor(
  ...
  protected generateElaborazioneEmissione(
    ...
    e = this._bmConverter.convertIBGIModalFormToElaborazione(fd, te, r);
