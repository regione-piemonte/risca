...
@Component({
  selector: 'bollettazione-speciale-modal',
  templateUrl: './bollettazione-speciale-modal.component.html',
  styleUrls: ['./bollettazione-speciale-modal.component.scss'],
})
export class BollettazioneSpecialeModalComponent extends BollettiniModalComponent<IBSModalForm> {
  /**
   * Costruttore.
   */
  constructor(
  ...
  protected generateElaborazioneEmissione(
    ...
    e = this._bmConverter.convertIBSModalFormToElaborazione(fd, te, r);
