...
@Component({
  selector: 'sollecito-pagamento-modal',
  templateUrl: './sollecito-pagamento-modal.component.html',
  styleUrls: ['./sollecito-pagamento-modal.component.scss'],
})
export class SollecitoPagamentoModalComponent
  ...
  implements OnInit
{
  ...
  protected generateElaborazioneEmissione(
    ...
    e = this._bmConverter.convertISPModalFormToElaborazione(fd, te, r);
