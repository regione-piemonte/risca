...
export class DettaglioMorositaService {
  /** StatoDebitorioVo contenente le informazioni da far utilizzare al componente dettaglio-morosita.component.ts per caricare le informazioni della pagina. */
