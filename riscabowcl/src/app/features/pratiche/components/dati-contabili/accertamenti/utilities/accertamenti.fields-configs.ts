...
import { AccertamentiConsts } from './accertamenti.consts';

/**
 * Interfacci di comodo per la configurazione della classe: BMFieldsConfigClass.
 */
export interface IAFieldsConfigClass {
 ...
 */
export class AFieldsConfigClass {
  ...
  tipoAccertamentoConfig: RiscaComponentConfig<RiscaFormInputSelect>;
   ...
   * Costruttore.
   */
  constructor(config: IAFieldsConfigClass) {
   ...
   */
  setupFormInputs() {
    this.tipoAccertamentoConfig = this._riscaFormBuilder.genInputSelect({
