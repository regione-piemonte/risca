 ...
 */
export class DTRicerca20211001Consts {
  ...
  /** Costante che identifica il nome del form control: quantita_da. */
  QUANTITA_DA = 'quantitaDa';
  /** Costante che identifica il nome del form control: quantita_a. */
  QUANTITA_A = 'quantitaA';
  ...
  /** Costante che identifica il nome del form control: dataScadenzaEmasIsoDa. */
  DATA_SCADENZA_EMAS_ISO_DA = 'dataScadenzaEmasIsoDa';
  /** Costante che identifica il nome del form control: dataScadenzaEmasIsoA. */
  DATA_SCADENZA_EMAS_ISO_A = 'dataScadenzaEmasIsoA';
  ...
  /** Costante che identifica la label quantita. */
  LABEL_QUANTITA = 'Quantita';
  ...
  /** Costante che identifica la label del campo: quantita da. */
  LABEL_DA = 'da';
  ...
  /** Costante che identifica la label per l'accordion degli usi di legge. */
  ACCORDION_USI_DI_LEGGE = 'Usi';
