 ...
 */
export class ValidatorDatiSoggettoPGModClass extends RequireDatiSoggettoClass {
  /**
   * Costruttore.
   */
  constructor() {
  ...
  private setupAccessi() {
    ...
    this.config[this.RDS_C.TIPO_SOGGETTO] = { isRequired: false };
    this.config[this.RDS_C.CODICE_FISCALE] = { isRequired: false };
