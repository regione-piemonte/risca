import { comuneDataFineValiditaFC } from 'src/app/shared/miscellaneous/forms-validators/soggetto/form-validators.r';
import { RequireRecapitiClass } from './require-recapiti.class';

/**
 * Classe per la gestione dell'accesso alla sezione: recapiti.
 */
export class ValidatorRecapitiInsClass extends RequireRecapitiClass {
  /**
   * Costruttore.
   */
  constructor() {
