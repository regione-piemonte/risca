 ...
 */
export class ValidatorDatiSoggettoPFModClass extends RequireDatiSoggettoClass {
  /**
   * Costruttore.
   */
  constructor() {
  ...
  private setupAccessi() {
    ...
    this.config[this.RDS_C.NATURA_GIURIDICA] = { isRequired: false };
    this.config[this.RDS_C.NOME] = { isRequired: true };
    this.config[this.RDS_C.COGNOME] = { isRequired: true };
    this.config[this.RDS_C.RAGIONE_SOCIALE] = { isRequired: false };
    this.config[this.RDS_C.PARTITA_IVA] = { isRequired: false, otherValidators: [partitaIvaValidator()] };
    this.config[this.RDS_C.COMUNE_NASCITA] = { isRequired: false };
    this.config[this.RDS_C.DATA_NASCITA] = { isRequired: true };
    this.config[this.RDS_C.STATO_NASCITA] = { isRequired: true };
