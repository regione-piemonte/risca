 ...
 */
export class DisabledRicercaAvanzataPraticheMRPraticaClass extends DisabledRicercaAvanzataPraticheClass {
  /**
   * Costruttore.
   */
  constructor() {
  ...
  private setupDisabilitazioni() {
    ...
    this.config[this.FRAP_C.TIPOLOGIA_PRATICA] = { disabled: false };
    this.config[this.FRAP_C.STATO_PRATICA] = { disabled: false };
    ...
    this.config[this.FRAP_C.DATA_RINUNCIA_REVOCA_DA] = { disabled: false };
    this.config[this.FRAP_C.DATA_RINUNCIA_REVOCA_A] = { disabled: false };
    this.config[this.FRAP_C.ANNO_CANONE] = { disabled: true };
    this.config[this.FRAP_C.CANONE] = { disabled: true };
    ...
    // this.config[this.FRAP_C.DATA_SCADENZA_EMAS_O_ISO_DA] = { disabled: false };
    // this.config[this.FRAP_C.DATA_SCADENZA_EMAS_O_ISO_A] = { disabled: false };
  }
}
